...
- **`Scalar`** — the Schema-side type object: one of the seven fixed kinds
  ...
  [`omnist/canonical/schema.py`](https://github.com/tomlee/omnist/blob/master/omnist/canonical/schema.py) and
...
- **`Record`** — the Python class: a closed set of `Field`s, constructed
  ...
  [`omnist/canonical/schema.py`](https://github.com/tomlee/omnist/blob/master/omnist/canonical/schema.py).
