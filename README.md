...
* **[Formats](docs/formats.md)** — Data Tree as a JSON/YAML/TOML hub (load + emit)
...
python -m pytest tests/   # 172 tests (paper examples, formats, DSL, conformance, serialization)
